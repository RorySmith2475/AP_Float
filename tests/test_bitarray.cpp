...
TEST_CASE("Modification operators")
{
    ...
    // SECTION("Random value repeated calculations")
    // {
    //     // auto i = GENERATE(range(0ull, 4223372036854775807ull, 922337203685477580ull));
    //     // SECTION("")
    //     // {
    //         // auto j = GENERATE(range(0ull, 4223372036854775807ull, 922337203685477580ull));

    //     BitArray a("54987254238974523789542387945328790542389704523789025437890524378904578904532890754238794235");
    //     BitArray b("2345789542387945238790453278904532789025439780234589074523897025349870254390878792345798324589732459874532");
    //     const BitArray c = a;
